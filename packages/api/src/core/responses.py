...
def success_response(
    ...
    """성공 응답을 반환합니다."""
    response = ApiResponse(success=True, data=data, pagination=pagination)
    return JSONResponse(
        content=response.model_dump(), status_code=status_code, headers=headers
    )
...
def error_response(
    ...
    """오류 응답을 반환합니다."""
    error_detail = ErrorDetail(code=code, message=message, field=field, params=params)
...
def pagination_info(page: int, page_size: int, total_items: int) -> PaginationInfo:
    """페이지네이션 정보를 생성합니다."""

...
from core.database import AsyncSession, Base
...
class NotificationGroup:
    ...
    def __init__(self, category: NotificationCategory, notifications: List[Notification]):
...
class NotificationService:
    ...
    def __init__(self, db: AsyncSession, settings: Settings, security: SecurityService):
        """
        알림 서비스 초기화
        ...
        self.batch_size = settings.NOTIFICATION_BATCH_SIZE or 100
    ...
    async def _run_scheduler(self):
        ...
        while True:
            ...
            # 실행할 알림 찾기
            to_run = [
                notification for notification in self.scheduled_notifications
    ...
    async def get_notification_groups(
        ...
        ).offset(skip).limit(min(limit, self.batch_size))

...
class MaintenanceModel(Base):
    ...
    status = Column(String(50), default=MaintenanceStatus.SCHEDULED.value, nullable=False, index=True)
...
class MaintenancePartModel(Base):
    ...
    condition = Column(String(50), default=PartCondition.NEW.value)  # new, used, refurbished

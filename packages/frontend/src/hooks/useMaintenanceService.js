...
const useMaintenanceService = () => {
     ...
     */
    const getVehicleMaintenanceSchedules = async (vehicleId) => {
        if (!vehicleId) {
     ...
     */
    const createMaintenanceSchedule = async (data) => {
        if (!data.vehicleId) {
            setError('차량 ID가 제공되지 않았습니다.');
            return null;
        }
     ...
     * @param data 업데이트 데이터
     */
    const updateMaintenanceSchedule = async (id, data) => {
        if (!id) {
            setError('정비 일정 ID가 제공되지 않았습니다.');
            return null;
        }
     ...
     */
    const createMaintenanceReport = async (data) => {
     ...
     */
    const getMaintenanceReport = async (maintenanceId) => {
        if (!maintenanceId) {
            setError('정비 일정 ID가 제공되지 않았습니다.');
            return null;
        }

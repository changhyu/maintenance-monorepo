...
export interface DashboardCardData {
  ...
  color?: string;
  icon?: 'file' | 'chart' | 'calendar' | 'line-chart' | string; // 서비스에서 다른 string 값도 허용
}
    ...
    const loadReportData = useCallback(async () => {
        ...
        try {
            ...
            const formattedReports: RecentReport[] = Array.isArray(reports) 
                ...
                : [];
            setRecentReports(formattedReports); // 최근 5개만, 배열 확인
            // 초기 차트 데이터 로드

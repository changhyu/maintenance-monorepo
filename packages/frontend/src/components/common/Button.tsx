 ...
 * 버튼 색상 스키마 타입 정의
 */
export type ButtonColorScheme = 'primary' | 'secondary' | 'danger' | 'warning' | 'success' | 'info' | 'gray';
...
export const Button: React.FC<ButtonProps> = ({
  ...
  // 비활성화 클래스
  const disabledClass = isDisabled || isLoading 
  ...
  return (
    ...
    >
      ...
      {!isLoading && leftIcon && (
        <span className={`${iconSizeClass[size]} ${iconSpacing[size]}`}>
          {leftIcon}
        </span>
      )}

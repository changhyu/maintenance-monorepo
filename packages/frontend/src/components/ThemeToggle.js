...
const ThemeToggle = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { id: "theme-change-announcement", className: "sr-only", "aria-live": "polite", "aria-atomic": "true", style: { position: 'absolute', width: '1px', height: '1px', overflow: 'hidden' } }), _jsx(Tooltip, { title: modeText, children: _jsx(StyledIconButton, { ref: buttonRef, color: "inherit", onClick: handleThemeToggle, "aria-label": modeText, "aria-pressed": darkMode, role: "switch", "data-testid": "theme-toggle-button", tabIndex: 0, sx: {
                        backgroundColor: theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.08)' : 'rgba(0, 0, 0, 0.04)',
                    }, children: darkMode ? (_jsx(Brightness7Icon, { "aria-hidden": "true", fontSize: "small" })) : (_jsx(Brightness4Icon, { "aria-hidden": "true", fontSize: "small" })) }) })] }));
};

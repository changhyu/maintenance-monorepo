...
// 커스텀 색상 팔레트 정의
const getCustomColors = (mode, color = 'blue') => {
    const colors = {
        blue: {
            light: blue[400],
            main: blue[600],
...
const getDesignTokens = (options) => {
    const { mode, color, borderRadius = 8, fontFamily = '"Inter", "Noto Sans KR", -apple-system, BlinkMacSystemFont, sans-serif' } = options;
...
// 테마 생성 함수
export const createAppTheme = (options) => getDesignTokens(options);
// 기본 테마

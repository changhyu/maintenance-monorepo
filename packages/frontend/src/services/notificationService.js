...
export const notificationService = {
     ...
     * 알림 배치 생성하기 (관리자용)
     */
    async createNotificationBatch(batchData) {
        try {
     ...
     * 알림 배치 상세 가져오기 (관리자용)
     */
    async getNotificationBatch(batchId) {
        try {
     ...
     * 알림 배치 삭제하기 (관리자용)
     */
    async deleteNotificationBatch(batchId) {
        try {
     ...
     * 알림 배치 실행하기 (관리자용)
     */
    async runNotificationBatch(batchId) {
        try {
     ...
     * 알림 배치 취소하기 (관리자용)
     */
    async cancelNotificationBatch(batchId) {
        try {
